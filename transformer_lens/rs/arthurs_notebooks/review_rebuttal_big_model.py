...
for fname in [
    "/workspace/SERI-MATS-2023-Streamlit-pages/transformer_lens/rs/arthurs_notebooks/my_tokens_tl.pt",
    "/workspace/SERI-MATS-2023-Streamlit-pages/transformer_lens/rs/arthurs_notebooks/my_logits_tl.pt",
]: # TODO check Llama-7B
    t1 = torch.load(fname)
    t2 = torch.load(fname.replace("_tl", ""))
...
import itertools
for layer, head in list(itertools.product([26, 27], list(range(32)))):
