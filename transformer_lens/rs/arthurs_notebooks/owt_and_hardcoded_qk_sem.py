...
for batch_idx in range(BATCH_SIZE):  # range(len(top_unembeds_per_position)):
    ...
    #     list(
    #         zip(
    #             cur_top_probs[0][top5p_seq_indices[batch_idx]].tolist(),
    #             model.to_str_tokens(cur_top_probs[1][top5p_seq_indices[batch_idx]]),
    #             cur_top_probs[1][top5p_seq_indices[batch_idx]].tolist(),
    #             strict=True,
    #         )
    #     )
    # )
