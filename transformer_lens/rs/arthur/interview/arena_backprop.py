#%%
# -*- coding: utf-8 -*-
"""part5 Backprop (exercises).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_aeNgUU8H7psOH8jttByO_8lv9Wp7O0o
...
[Streamlit page](https://arena-ch0-fundamentals.streamlit.app/[0.5]_Backprop)
...
# Need to make sure both subfunctions within functions are appropriately commented out in the instructions file (and instructions colab).
